## Consignes
J'EN AI MARRE DE CET EXAM PTN 
Vous travaillez en groupe sur un dépôt GitHub pour produire un site web en Golang.

Le site affiche pour le moment une page vide. une fonctionnalités seront développées en parallèle, depuis la branche `dev` déjà existante (voir schéma de l’état initial du dépôt).
